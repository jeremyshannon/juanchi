...
rcbows.register_arrow("farbows:mese_arrow", {
	damage = 8,
	inventory_arrow = {
		name = "farbows:inv_mese_arrow",
		description = S("Mese Arrow"),
		inventory_image = "farbows_mese_arrow.png",
	},
	embed = {
		texture = "farbows_arrow_stick.png",
...
rcbows.register_bow("farbows:bow_mese", {
	...
	overlay_empty = "farbows_overlay_empty.png",
	overlay_charged = "farbows_overlay_charged.png",
	arrows = {"farbows:mese_arrow", "farbows:e_arrow"},
	sounds = {
		max_hear_distance = 10,
		gain = 0.4,
	},
